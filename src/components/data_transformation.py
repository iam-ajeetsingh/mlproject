...
import numpy as np
import pandas as pd
from sklearn.compose import ColumnTransformer   # ColumnTransformer is used to apply different preprocessing to different columns.
from sklearn.impute import SimpleImputer    # Imputer is deprecated in the latest version of sklearn
...
class DataTransformation:
    ...
    '''
    This method is responsible for creating the data transformation
    '''
